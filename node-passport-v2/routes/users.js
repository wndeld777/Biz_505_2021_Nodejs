...
// http://localhost/users 라고 호출했을때 응답
router.post("/", (req, res) => {
 ...
 * queryString 방식(위험) : 주소창에 ?변수1=값&변수2=값 과 같은 형식으로 전송
 * 		http://localhost:8080/user?id=root&password=1234
 * => 서버에서 받을때는 req.query.변수
 * PathVarriable 방식 : 주소창에 보내는데 URL과 섞어서 보내는 방식
 * 		http://localhost:8080/user/callor/1234
 * => router.get("/user/:id/:password") 설정을 하고
