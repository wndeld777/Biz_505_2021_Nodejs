...
router.get("/detail", (req, res) => {
  ...
  // tbl_replay 의 r_postId = b_id 칼럼으로 WHERE 를 실행하여
  // tbl_replay 를 SELECT 하고 그 list 를 함께 묶어서 결과로 달라
  // findOne 은 where 절을 사용해서 b_id 값고정
  tbl_bbs
    .findOne({
      where: { b_id },
 ...
 * 이렇게 받은 데이터를 sequelize 를 사용하여 DB에
 * insert, update
 ...
 *
 * router.get("/reply/delete/:rid") 로 URL path 를 설정하고
